...
namespace Microsoft.AspNetCore.Mvc
{
    ...
    public static class ControllerExtensions
    {
        ...
        public static async Task<IActionResult> GetActionResultAsync(this ControllerBase controller, HttpResponseMessage responseMessage)
        {
        ...
        /// <returns>The action result.</returns>
        public static IActionResult Exception(this ControllerBase controller, Exception exception)
        {
        ...
        private static void CopyResponseHeaders(this ControllerBase controller, HttpResponseHeaders responseHeaders)
        {
